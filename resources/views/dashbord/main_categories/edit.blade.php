...
<div class="content-body">
    ...
    <div class="row page-titles mx-0">
        <div class="col p-md-0">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{__('admin.edit-cat')}}</li>
            </ol>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form id="step-form-horizontal" class="step-form-horizontal"  method="post"  action="{{route('admin.editcategoriescheck',$main->id)}}}" enctype="multipart/form-data">
                    <div>
                        @csrf
                        @isset($main)
