    ...
    <ul class="navbar-nav ml-auto mr-3">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <a href="#" class="dropdown-item">
                    <!-- Message Start -->
                    <div class="media">
                        <img src="{{asset('assets/image/user1-128x128.jpg')}}" alt="User Avatar" class="img-size-50 mr-3 img-circle">
                ...
                <a href="#" class="dropdown-item">
                    <!-- Message Start -->
                    <div class="media">
                        <img src="{{asset('assets/image/user8-128x128.jpg')}}" alt="User Avatar" class="img-size-50 img-circle mr-3">
                        <div class="media-body">
                            <h3 class="dropdown-item-title">
                                John Pierce
                ...
                <a href="#" class="dropdown-item">
                    <!-- Message Start -->
                    <div class="media">
                        <img src="{{asset('assets/image/user3-128x128.jpg')}}" alt="User Avatar" class="img-size-50 img-circle mr-3">
                        <div class="media-body">
                            <h3 class="dropdown-item-title">
                                Nora Silvester
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right p-0" style="">
                <a href="#" class="dropdown-item">
                    <i class="fas fa-user mr-2"></i> {{__("admin/nav.My_profil")}}
                </a>
                <a href="#" class="dropdown-item">
                    <i class="fas fa-edit mr-2"></i> {{__("admin/nav.Settings")}}
                </a>
                <a href="#" class="dropdown-item">
                    <i class="fas fa-sign-out-alt mr-2"></i> {{__("admin/nav.Sign-out")}}
                </a>
            </div>
        </li>
    </ul>
