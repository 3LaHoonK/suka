...
<div class="content-body">
    ...
    <div class="row page-titles mx-0">
        <div class="col p-md-0">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{__('admin.add-sub-cat')}}</li>
            </ol>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form id="step-form-horizontal" class="step-form-horizontal"  method="post"  action="{{route('admin.addsubcategoriescheck')}}" enctype="multipart/form-data">
                    @csrf
                    <div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        placeholder="{{__('admin.NAME') . __('admin.' . $activeLanguages->abbr)}}" value="{{old('category[$conn][name]')}}" required>
                                ...
                                <div class="col-lg-12" style="text-align: center ;top: 30px">
                                    <div class="form-group" >
                                        <div class="form-group" >
                        ...
                        <section>
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <select class="form-control" id="val-skill" name="perant_id">
