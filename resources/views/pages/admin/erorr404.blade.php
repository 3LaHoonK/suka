                        ...
                        <div class="card mb-0">
                            <div class="card-body text-center pt-5">
                                ...
                                <form class="mt-5 mb-5">
                                    ...
                                    <div class="text-center mb-4 mt-4"><a href="{{route('dashbord')}}" class="btn btn-primary">Go to Homepage</a>
                                    </div>
                                </form>
                        ...
                        <div class="card mb-0">
                            <div class="card-body text-center">
                                ...
                                <form class="mt-5 mb-5">
                                    ...
                                    <div class="text-center mb-4 mt-4"><a href="index.blade.php" class="btn btn-primary">Go to Homepage</a>
                                    </div>
                                </form>
                                <div class="text-center">
                                    <p>Copyright © Designed by <a href="https://themeforest.net/user/digitalheaps">Digitalheaps</a>, Developed by <a href="https://themeforest.net/user/quixlab">Quixlab</a> 2018</p>
