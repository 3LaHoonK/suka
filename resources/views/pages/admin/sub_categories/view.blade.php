    ...
    <div class="row page-titles mx-0">
        <div class="col p-md-0">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="">{{__('admin.sub_categories')}}</a></li>
            </ol>
        </div>
    </div>
    <!-- row -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6" >
                                <h2 class="card-title">{{__('admin.sub-Categories-list')}}</h2>
                            </div>
                            <div class="col-6" >
                                <div class="dropdown custom-dropdown float-right">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(14px, 21px, 0px);">
                                        <a class="dropdown-item" href="{{route('admin.selectsubcategories',$action = 'all')}}">All</a>
                                        <a class="dropdown-item" href="{{route('admin.selectsubcategories',$action = 'main')}}">main</a>
                                        <a class="dropdown-item" href="{{route('admin.selectsubcategories',$action = 'active')}}">active</a>
                                        <a class="dropdown-item" href="{{route('admin.selectsubcategories',$action = 'inactive')}}">inactive</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    @foreach ($categorie as $categories)
                                        <tr style="text-align: center">
                                            ...
                                            <td>
                                                ...
                                                <a title="{{__('admin.active')}}" href="{{route('admin.activesubcategories', $categories -> id )}}">
                                                ...
                                                <a title="{{__('admin.edite')}}" href="{{route('admin.editsubcategories', $categories -> id )}}">
                                                    <button type="button" class="btn btn-outline-success"><i class="fa fa-edit"></i></button>
                                                </a><br>

                                                <a title="{{__('admin.delete')}}" href="{{route('admin.deletesubcategories', $categories -> id )}}">
